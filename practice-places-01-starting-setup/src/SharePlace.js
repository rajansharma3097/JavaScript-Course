...
class PlaceFinder {
  ...
  locateUserHandler() {
    if (!navigator.geolocation) {
      alert("Location feature is not available in your browser, please use modern browser.");
      return;
    }
    ...
    navigator.geolocation.getCurrentPosition(async successResult => {
      ...
      modal.hide();
      alert("Could not locate you unfortunately, please update address anually! ");
    });
  }
